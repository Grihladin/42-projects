...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/27 21:15:03 by mratke            #+#    #+#             */
/*   Updated: 2025/06/27 21:41:08 by mratke           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Harl::info(void) {
  std::cout
      << "[ INFO ]\nI cannot believe adding extra bacon costs more money. You "
         "didn’t putenough bacon in my burger! If you did, I wouldn’t be "
         "asking for more!\n";
}
...
void Harl::warning(void) {
  std::cout
      << "[ WARNING ]\nI think I deserve to have some extra bacon for free. "
         "I’ve been "
         "coming foryears, whereas you started working here just last month.\n";
}
